...
title_en: "Memorial to Chiang Kai-shek on a Plan of Operations for the Northeast, 11 April 1948"
author: "廖耀湘"
category: "廖耀湘文集"
tags: 分类
date:  1948-04-11 00:00:00 +0000
english_abstract: >
  A secret personal memorial, with attached operational plan, from Liao as
  Ninth Army Group commander to Chiang Kai-shek, held in the Academia
  Historica. He warns that Shenyang's forces are dispersed and command is
  paralyzed, risking defeat in detail. He proposes holding only five outer
  strongpoints plus the city with a small force, and concentrating six
  armies (New 1st, New 6th, New 3rd, 71st, 52nd, and 53rd—the old Chinese
  Army in India and Expeditionary Force cores) into two attack groups under
  unified command, to seek a decisive battle and reopen the Jinzhou–Shenyang
  corridor. Wei Lihuang has been informed, but Liao says the decision must
  come from Chiang; delay or political hesitation could ruin the army. A key
  primary source on Nationalist strategy in Manchuria between the winter
  offensive and the Liaoshen campaign.
---
主席钧鉴：
